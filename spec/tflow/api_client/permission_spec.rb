...
describe Tflow::ApiClient::Permission do
  before(:each) do
   ...
   it 'should list permissions' do
     stub_request(:get, 'http://10.0.0.1/api/v2/permission/list').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("permissions.json"))
