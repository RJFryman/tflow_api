...
describe Tflow::ApiClient::Job do
  before(:each) do
   ...
   it 'should list all job transitions' do
     stub_request(:get, 'http://10.0.0.1/api/v2/job/100/allowedTransitions').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job_transitions.json"))
   ...
   it 'should execute a transistion on a job' do
     stub_request(:post, 'http://10.0.0.1/api/v2/job/100/executeTransition').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job_transition.json"))
     response = @client.executeTransition(100, "approve")
     response.should == {"id"=>100, "name"=>"approve"}
   end

   it 'should list all job revisions' do
     stub_request(:get, 'http://10.0.0.1/api/v2/job/100/revisions').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job_revisions.json"))
   ...
   it 'it should create an order' do
     stub_request(:post, 'http://10.0.0.1/api/v2/job/create').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job.json"))
     json_payload = {
         "name": "rem",
         "order_id": 1,
         "kfpx": "CMYK",
   ...
   it 'should list all jobs' do
     stub_request(:get, 'http://10.0.0.1/api/v2/job/list').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("jobs.json"))
   ...
   it 'should get a specific job based on id' do
     stub_request(:get, 'http://10.0.0.1/api/v2/job/100').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job.json"))
     response = @client.get_job('100')
     response.should == {"name"=>"rem", "order_id"=>1, "kfpx"=>"CMYK", "ship_date"=>"2018-11-30T23:59:59+07", "description"=>"Nisi nemo reiciendis porro ut nemo a sapiente. Ducimus ut maxime corporis reiciendis.", "notes"=>"omnis dolorem veniam illum officia at praesentium est ad id", "priority"=>2, "attach_proofs"=>false, "assignments"=>{"upload_revision"=>[{"user_id"=>100}], "approve_jobs"=>[{"user_id"=>100}], "release_jobs"=>[{"user_id"=>100}], "upload_proofs"=>[{"user_id"=>100}]}, "tflows"=>[{"id"=>"808:1"}, {"id"=>"909:5"}], "props"=>{"print_width"=>136.573, "print_height"=>362.36, "sales_rep"=>"1", "quantity"=>80, "shipping_address"=>"61856 Farrell Loop\nLake Ezekiel, KS 05244", "phone_contact"=>"750.379.0693", "email_contact"=>"lonny.wisozk@altenwerth.com"}}
   end

   it 'should clear a rush request' do
     stub_request(:post, 'http://10.0.0.1/api/v2/job/100/rush/clear').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job.json"))
     response = @client.clear_rush_request_job('100')
     response.should == {"name"=>"rem", "order_id"=>1, "kfpx"=>"CMYK", "ship_date"=>"2018-11-30T23:59:59+07", "description"=>"Nisi nemo reiciendis porro ut nemo a sapiente. Ducimus ut maxime corporis reiciendis.", "notes"=>"omnis dolorem veniam illum officia at praesentium est ad id", "priority"=>2, "attach_proofs"=>false, "assignments"=>{"upload_revision"=>[{"user_id"=>100}], "approve_jobs"=>[{"user_id"=>100}], "release_jobs"=>[{"user_id"=>100}], "upload_proofs"=>[{"user_id"=>100}]}, "tflows"=>[{"id"=>"808:1"}, {"id"=>"909:5"}], "props"=>{"print_width"=>136.573, "print_height"=>362.36, "sales_rep"=>"1", "quantity"=>80, "shipping_address"=>"61856 Farrell Loop\nLake Ezekiel, KS 05244", "phone_contact"=>"750.379.0693", "email_contact"=>"lonny.wisozk@altenwerth.com"}}
   end

   it 'should delete a job' do
     stub_request(:delete, "http://10.0.0.1/api/v2/job/100").
     ...
     response = @client.delete_job('100')
     response.should == "nothing"
   end

   it 'should re preflight a job' do
     stub_request(:post, 'http://10.0.0.1/api/v2/job/100/repreflight').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job.json"))
     response = @client.re_preflight('100')
     response.should == {"name"=>"rem", "order_id"=>1, "kfpx"=>"CMYK", "ship_date"=>"2018-11-30T23:59:59+07", "description"=>"Nisi nemo reiciendis porro ut nemo a sapiente. Ducimus ut maxime corporis reiciendis.", "notes"=>"omnis dolorem veniam illum officia at praesentium est ad id", "priority"=>2, "attach_proofs"=>false, "assignments"=>{"upload_revision"=>[{"user_id"=>100}], "approve_jobs"=>[{"user_id"=>100}], "release_jobs"=>[{"user_id"=>100}], "upload_proofs"=>[{"user_id"=>100}]}, "tflows"=>[{"id"=>"808:1"}, {"id"=>"909:5"}], "props"=>{"print_width"=>136.573, "print_height"=>362.36, "sales_rep"=>"1", "quantity"=>80, "shipping_address"=>"61856 Farrell Loop\nLake Ezekiel, KS 05244", "phone_contact"=>"750.379.0693", "email_contact"=>"lonny.wisozk@altenwerth.com"}}
   end

   it 'should set rush to a job' do
     stub_request(:post, 'http://10.0.0.1/api/v2/job/100/rush/request').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job.json"))
     response = @client.set_rush_job('100')
     response.should == {"name"=>"rem", "order_id"=>1, "kfpx"=>"CMYK", "ship_date"=>"2018-11-30T23:59:59+07", "description"=>"Nisi nemo reiciendis porro ut nemo a sapiente. Ducimus ut maxime corporis reiciendis.", "notes"=>"omnis dolorem veniam illum officia at praesentium est ad id", "priority"=>2, "attach_proofs"=>false, "assignments"=>{"upload_revision"=>[{"user_id"=>100}], "approve_jobs"=>[{"user_id"=>100}], "release_jobs"=>[{"user_id"=>100}], "upload_proofs"=>[{"user_id"=>100}]}, "tflows"=>[{"id"=>"808:1"}, {"id"=>"909:5"}], "props"=>{"print_width"=>136.573, "print_height"=>362.36, "sales_rep"=>"1", "quantity"=>80, "shipping_address"=>"61856 Farrell Loop\nLake Ezekiel, KS 05244", "phone_contact"=>"750.379.0693", "email_contact"=>"lonny.wisozk@altenwerth.com"}}
   end

   it 'should undo a rush a job' do
     stub_request(:post, 'http://10.0.0.1/api/v2/job/100/rush/undoRequest').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job.json"))
     response = @client.undo_rush_request('100')
     response.should == {"name"=>"rem", "order_id"=>1, "kfpx"=>"CMYK", "ship_date"=>"2018-11-30T23:59:59+07", "description"=>"Nisi nemo reiciendis porro ut nemo a sapiente. Ducimus ut maxime corporis reiciendis.", "notes"=>"omnis dolorem veniam illum officia at praesentium est ad id", "priority"=>2, "attach_proofs"=>false, "assignments"=>{"upload_revision"=>[{"user_id"=>100}], "approve_jobs"=>[{"user_id"=>100}], "release_jobs"=>[{"user_id"=>100}], "upload_proofs"=>[{"user_id"=>100}]}, "tflows"=>[{"id"=>"808:1"}, {"id"=>"909:5"}], "props"=>{"print_width"=>136.573, "print_height"=>362.36, "sales_rep"=>"1", "quantity"=>80, "shipping_address"=>"61856 Farrell Loop\nLake Ezekiel, KS 05244", "phone_contact"=>"750.379.0693", "email_contact"=>"lonny.wisozk@altenwerth.com"}}
   end

   it 'should update a job' do
     stub_request(:post, 'http://10.0.0.1/api/v2/job/1/update').to_return(:headers => {"Content-Type"=> "application/json"}, :body => fixture("job.json"))
     json_payload = {
         "name": "rem",
         "order_id": 1,
         "kfpx": "CMYK",
     ...
     response = @client.update_job(1 ,json_payload)
     response.should == {"name"=>"rem", "order_id"=>1, "kfpx"=>"CMYK", "ship_date"=>"2018-11-30T23:59:59+07", "description"=>"Nisi nemo reiciendis porro ut nemo a sapiente. Ducimus ut maxime corporis reiciendis.", "notes"=>"omnis dolorem veniam illum officia at praesentium est ad id", "priority"=>2, "attach_proofs"=>false, "assignments"=>{"upload_revision"=>[{"user_id"=>100}], "approve_jobs"=>[{"user_id"=>100}], "release_jobs"=>[{"user_id"=>100}], "upload_proofs"=>[{"user_id"=>100}]}, "tflows"=>[{"id"=>"808:1"}, {"id"=>"909:5"}], "props"=>{"print_width"=>136.573, "print_height"=>362.36, "sales_rep"=>"1", "quantity"=>80, "shipping_address"=>"61856 Farrell Loop\nLake Ezekiel, KS 05244", "phone_contact"=>"750.379.0693", "email_contact"=>"lonny.wisozk@altenwerth.com"}}
  end
end
